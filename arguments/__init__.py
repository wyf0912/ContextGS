...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.latent_codec_lr_init = 0.005
        self.latent_codec_lr_final = 0.00001
        self.latent_codec_lr_delay_mult = 0.33
        self.latent_codec_lr_max_steps = 30_000
